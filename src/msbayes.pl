...
sub ExtractMspriorConf {
    ...
    my @generalKwdArr = qw(thetaShape thetaScale tauShape tauScale bottleProportionShapeA bottleProportionShapeB migrationShape migrationScale upperRec ancestralThetaMultiplier reps numTauClasses  constrain subParamConstrain numTaxonLocusPairs numTaxonPairs numLoci prngSeed configFile);
...
sub MkNewMspriorBatchConf {
    ...
    my @generalKwdArr = qw(thetaShape thetaScale tauShape tauScale bottleProportionShapeA bottleProportionShapeB migrationShape migrationScale upperRec ancestralThetaMultiplier reps numTauClasses constrain subParamConstrain prngSeed);
